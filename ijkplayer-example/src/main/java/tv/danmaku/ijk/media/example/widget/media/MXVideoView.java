...
public class MXVideoView extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    public MXVideoView(@NonNull Context context) {
        this(context, null, 0);
    }

    public MXVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MXVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
