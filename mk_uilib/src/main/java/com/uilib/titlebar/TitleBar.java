...
//            view_bg.setBackgroundColor(ta.getColor(R.styleable.TitleBar_titleBgColor, getResources().getColor(R.color.colorPrimary)));
            ...
            backIcon = ta.getResourceId(R.styleable.TitleBar_backIcon, NO_ID);

            btn_back.setImageResource(backStyle == ARROW ? getArrowIcon() : android.R.drawable.ic_menu_close_clear_cancel);
    ...
    private int getArrowIcon(){
        return backIcon == NO_ID ? android.R.drawable.ic_menu_revert : backIcon;
    }
